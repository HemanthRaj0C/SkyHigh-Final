...
export const planetsDataDetailed: Record<string, PlanetData> = {
  ...
  ceres: {
    ...
    quickFacts: {
      ...
      moons: '0',
      surfaceTemperature: '-105°C',
      mass: '9.38 × 10²⁰ kg',
      gravity: '0.28 m/s²',
    },
    composition: {
      summary: 'Rocky core with water ice mantle, possibly subsurface ocean',
      atmosphere: ['Trace water vapor'],
    },
    notableFeatures: [
      'Largest object in the asteroid belt',
      'Only dwarf planet in the inner Solar System',
      'Contains bright spots (salt deposits) in Occator Crater',
      'May have a subsurface ocean',
      'Visited by NASA\'s Dawn mission (2015-2018)',
      'Named after the Roman goddess of agriculture',
    ],
    apis: [
      {
        name: 'NASA API - Dawn Mission',
        url: 'https://api.nasa.gov/',
        description: 'Data and images from the Dawn spacecraft mission to Ceres',
      },
    ],
  },
  vesta: {
    name: 'vesta',
    displayName: 'Vesta',
    image: '/textures/vesta.jpg',
    description: 'Vesta is the second-largest asteroid in the main asteroid belt, with a unique differentiated structure.',
    quickFacts: {
      diameter: '525 km',
      distanceFromSun: '353.4 million km (2.36 AU)',
      orbitalPeriod: '3.63 Earth years',
      rotationPeriod: '5.34 hours',
      moons: '0',
      surfaceTemperature: '-188°C to -18°C',
      mass: '2.59 × 10²⁰ kg',
      gravity: '0.25 m/s²',
    },
    composition: {
      summary: 'Differentiated body with iron-nickel core, rocky mantle, and basaltic crust',
      atmosphere: ['None'],
    },
    notableFeatures: [
      'Second-largest asteroid in the main belt',
      'Has a giant impact crater (Rheasilvia) at its south pole',
      'Brightest asteroid visible from Earth',
      'Source of HED meteorites found on Earth',
      'Differentiated like terrestrial planets',
      'Visited by NASA\'s Dawn mission (2011-2012)',
    ],
    apis: [
      {
        name: 'NASA API - Dawn Mission',
        url: 'https://api.nasa.gov/',
        description: 'Vesta data and imagery from Dawn spacecraft',
      },
    ],
  },
  pallas: {
    name: 'pallas',
    displayName: 'Pallas',
    image: '/textures/pallas.jpg',
    description: 'Pallas is the third-largest asteroid, known for its highly inclined and eccentric orbit.',
    quickFacts: {
      diameter: '512 km',
      distanceFromSun: '414.5 million km (2.77 AU)',
    ...
    composition: {
      summary: 'Primitive carbonaceous composition, possibly hydrated silicates',
      atmosphere: ['None'],
    },
    notableFeatures: [
      'Third-largest asteroid by mass and volume',
      'Highly inclined orbit (34.8 degrees)',
      'Heavily cratered ancient surface',
      'Named after Pallas Athena, Greek goddess of wisdom',
      'Has irregular, non-spherical shape',
      'Difficult to observe due to orbital inclination',
    ],
    apis: [
      {
        name: 'NASA API - Asteroid Data',
        url: 'https://api.nasa.gov/',
        description: 'General asteroid data and tracking information',
      },
    ],
  },
  haumea: {
    name: 'haumea',
    displayName: 'Haumea',
    image: '/textures/haumea.jpg',
    description: 'Haumea is a dwarf planet in the Kuiper Belt with an unusual elongated shape and two known moons.',
    quickFacts: {
      diameter: '~1,632 km (elongated)',
      distanceFromSun: '6.45 billion km (43.3 AU)',
      orbitalPeriod: '283 Earth years',
      rotationPeriod: '3.9 hours (fastest in Solar System)',
      moons: '2 (Hiʻiaka and Namaka)',
      surfaceTemperature: '-223°C',
      mass: '4.01 × 10²¹ kg',
      gravity: '0.63 m/s²',
    },
    composition: {
      summary: 'Rocky core covered with water ice, elongated due to rapid rotation',
      atmosphere: ['None detected'],
    },
    notableFeatures: [
      'Fastest rotating large object in Solar System',
      'Elongated ellipsoid shape due to rapid spin',
      'Has a ring system discovered in 2017',
      'Two known moons: Hiʻiaka and Namaka',
      'Named after Hawaiian goddess of childbirth',
      'Surface covered in crystalline water ice',
    ],
    apis: [
      {
        name: 'NASA API - Kuiper Belt Objects',
        url: 'https://api.nasa.gov/',
        description: 'Data on trans-Neptunian objects and dwarf planets',
      },
    ],
  },
  makemake: {
    ...
    image: '/textures/makemake.jpg',
    description: 'Makemake is a dwarf planet in the Kuiper Belt, the second brightest object beyond Neptune after Pluto.',
    quickFacts: {
      diameter: '~1,430 km',
      distanceFromSun: '6.85 billion km (45.8 AU)',
      orbitalPeriod: '306 Earth years',
      rotationPeriod: '22.5 hours',
      moons: '1 (S/2015 (136472) 1 "MK 2")',
      surfaceTemperature: '-239°C',
      mass: '~3.1 × 10²¹ kg',
      gravity: '0.5 m/s²',
    },
    composition: {
      summary: 'Mixture of frozen methane, ethane, and nitrogen with rocky interior',
      atmosphere: ['Possible thin atmosphere of nitrogen'],
    },
    notableFeatures: [
      'Second brightest Kuiper Belt object after Pluto',
      'Reddish-brown color from tholins on surface',
      'Surface covered with frozen methane',
      'Has one known moon discovered in 2016',
      'Named after Rapa Nui creation deity',
      'One of the largest known trans-Neptunian objects',
    ],
    apis: [
      {
        name: 'NASA API - Kuiper Belt Objects',
        url: 'https://api.nasa.gov/',
        description: 'Kuiper Belt and dwarf planet research data',
      },
    ],
  },
  eris: {
    name: 'eris',
    displayName: 'Eris',
    image: '/textures/eris.jpg',
    description: 'Eris is a dwarf planet in the scattered disc, slightly smaller than Pluto but more massive, whose discovery led to Pluto\'s reclassification.',
    quickFacts: {
      diameter: '~2,326 km',
      distanceFromSun: '10.1 billion km (68 AU) average',
      orbitalPeriod: '558 Earth years',
      rotationPeriod: '25.9 hours',
      moons: '1 (Dysnomia)',
      surfaceTemperature: '-231°C',
      mass: '1.66 × 10²² kg (27% more massive than Pluto)',
      gravity: '0.82 m/s²',
    },
    composition: {
      summary: 'Rocky interior with surface ice of frozen methane and nitrogen',
      atmosphere: ['Thin atmosphere that freezes and falls as snow when far from Sun'],
    },
    notableFeatures: [
      'Most massive known dwarf planet',
      'Discovery triggered Pluto\'s reclassification',
      'Highly eccentric and inclined orbit',
      'One of most reflective objects in Solar System',
      'Has one moon named Dysnomia',
      'Named after Greek goddess of strife and discord',
    ],
    apis: [
      {
        name: 'NASA API - Dwarf Planets',
        url: 'https://api.nasa.gov/',
        description: 'Research data on dwarf planets and scattered disc objects',
      },
      {
        name: 'Minor Planet Center',
        url: 'https://minorplanetcenter.net/',
        description: 'Orbital elements and observation data for Eris',
      },
    ],
  },
};
