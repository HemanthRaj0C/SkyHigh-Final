...
export const planetsDataDetailed: Record<string, PlanetData> = {
  ...
  hygiea: {
    name: 'hygiea',
    displayName: 'Hygiea',
    image: '/textures/hygiea.jpg',
    description: 'Hygiea is the fourth-largest asteroid and potentially the smallest dwarf planet.',
    quickFacts: {
      diameter: '434 km',
      distanceFromSun: '470.3 million km (3.14 AU)',
    ...
    composition: {
      summary: 'Carbonaceous C-type asteroid, likely contains water and organic compounds',
      atmosphere: ['None'],
    },
    notableFeatures: [
      'Fourth-largest asteroid in the main belt',
      'Nearly spherical shape, may qualify as dwarf planet',
      'Darkest of the four largest asteroids',
      'Shows evidence of giant impact in its past',
      'Named after Hygieia, Greek goddess of health',
      'Part of the large Hygiea family of asteroids',
    ],
    apis: [
      {
        name: 'NASA API - Asteroid Data',
        url: 'https://api.nasa.gov/',
        description: 'Asteroid tracking and scientific data',
      },
    ],
  },
};
